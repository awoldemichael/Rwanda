...
*******************************************
use "$path2010/RWMR61FL.DTA", clear
...
isid v001 v002
save "$pathout/hh_occupM2010.dta", replace
clear

*********************************************
* Add in data about female occupation in hh *
*********************************************
use "$path2010/RWIR61FL.DTA", clear
...
save "$pathout/hh_occupF2010.dta", replace

***********************************************
* Adding in personal records for demographics *
***********************************************
use "$path2010/RWPR61FL.dta", clear
...
merge 1:1 v001 v002 using "$pathout/hh_occupF2010.dta", gen(_occupF)
merge 1:1 v001 v002 using "$pathout/hh_occupM2010.dta", gen(_occupM)
...
save "$pathout/hhdemog2010.dta", replace

********************
* Household info *
use "$path2010/RWHR61FL.dta", clear
...
recode hv230a (2 3 4 9 = 0 "unobserved") (1 = 1 "observed"), gen(handwash)
...
rename (hv246a hv246c hv246d hv246e hv246f hv246g hv246h hv246i hv246j)/*
      */ (cowtrad horse goat sheep chicken cowmilk cowbull pig rabbit) 
